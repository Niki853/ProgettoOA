...
public class Model
{
	...
	/*private void printINFO() throws GRBException {
		GRBLinExpr obj = model.getObjective(0);
		System.out.println("Get objective:: ")  model.getObjective());
		System.out.println("Get NumbBinVars:: "+model.get(IntAttr.NumBinVars));
	}*/
	...
	public void solve()
	{
		try {
			...
			System.out.println("CIAO ANNA");		System.out.println("CIAO ANNA");		System.out.println("CIAO ANNA");
